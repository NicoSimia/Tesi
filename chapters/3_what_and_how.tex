...
Il cursore a forma di mano, infine, accompagna costantemente il focus corrente, rendendo immediatamente riconoscibile l'elemento che riceverà il successivo \textit{input} del giocatore.
...
Sottoponendo il gioco ai sei \textit{test}, quattro sono stati superati senza particolari difficoltà: alcuni verificavano condizioni simili a quelle riscontrate poi nel \textit{test} 6, altri richiedevano semplicemente di eseguire manualmente una sequenza di operazioni — come il trasferimento del salvataggio tra account utente tramite backup su scheda SD — verificando che i dati rimanessero coerenti al termine del trasferimento.

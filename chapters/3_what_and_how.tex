...
Per il versionamento del progetto, come già accennato nel primo capitolo, abbiamo usato il \textit{software} Git insieme a Bitbucket, ospitato su un'infrastruttura indipendente dall'azienda.

La Figura~\ref{fig:versionamento-workflow} sintetizza il flusso di lavoro descritto in questa sezione, dalla creazione del \textit{branch} principale alla pubblicazione delle build, evidenziando la struttura a due rami separati adottata dopo l'arrivo del secondo stagista.

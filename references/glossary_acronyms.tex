...
\newglossaryentry{api_ext}{
    ...
    description={Un insieme di procedure atte a consentire la comunicazione tra diversi computer o tra diversi \textit{software} o tra diversi componenti di \textit{software}}
}

\newglossaryentry{sdk_ext}{
    name={Software Development Kit (SDK)},
    description={Un insieme di strumenti per lo sviluppo e la documentazione di \textit{software}}
}
...
\newglossaryentry{startupper}{
    name={Startupper},
    description={Un imprenditore che ha fondato una \textit{startup}, ovvero che fatto dell'innovazione il pilastro fondante di tutto il suo modello di business}
}
...
\newglossaryentry{Unity}{
    name={Unity},
    description={Uno dei due principali \textit{game engine} pubblici usati nel mercato videoludico. Spesso usato da studi indipendenti per la sua facilità a discapito di potenzialità maggiori}
}

\newglossaryentry{Unreal Engine}{
    name={Unreal Engine},
    description={Uno dei due principali \textit{game engine} pubblici usati nel mercato videoludico. Sta prendendo piede come \textit{standard} del mercato videoludico, utilizzato anche al posto degli \textit{engine} propietari negli studio più grandi. Tuttavia richiede una curva di apprendimento più ripida}
}

\newglossaryentry{Steam}{
    name={Steam},
    description={La più grande piattaforma di distribuzione di giochi su \textit{PC}, sia portatili e che fissi. Fornisce anche ulteriori servizi agli sviluppatori per lo sviluppo di videogiochi permettendo l'integrazione con la piattaforma}
}

\newglossaryentry{Git}{
    name={Git},
    description={Un sistema di controllo distribuito del versionamento \textit{open source}, utilizzato per progetti di piccola o grande dimensione}
}

\newglossaryentry{Bitbucket}{
    name={Bitbucket},
    description={Un servizio di \textit{hosting web-based} per progetti che usano i sistemi di controllo versione Mercurial o Git}
}
